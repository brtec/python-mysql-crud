...
class Application:
    def __init__(self, master=None):
        ...
        self.bntImprimir = Button(self.container8, text="Imprimir", 
        font=self.fonte, width=12)
        self.bntImprimir["command"] = self.imprimirUsuario
        self.bntImprimir.pack(side=LEFT)
...
root = Tk()
Application(root)
root.title("Módulo de Recebimento - ZAPBL")
root.geometry("1500x320") 
root.resizable(1, 1)
root.mainloop()